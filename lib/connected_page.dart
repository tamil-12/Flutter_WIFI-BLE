...
import './widgets/ControlPage.dart';
  ...
  Widget buildRssiTile(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(((isConnected && _rssi != null) ? '${_rssi!} dBm' : ''), style: Theme.of(context).textTheme.bodyText2)
      ],
    );
  }
      ...
      trailing: DropdownButton<String>(
        onChanged: (String? value) {
          if (value == 'services') {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => ControlPage(service: _services.first)),
            );
          }
        },
        items: [
