...
import "../utils/snackbar.dart";
import "descriptor_tile.dart";
import "../screens/Control_page.dart"; // Import the ControlPage widget
...
class _CharacteristicTileState extends State<CharacteristicTile> {
  ...
  Widget buildControlPageButton(BuildContext context) {
    return TextButton(
      ...
      onPressed: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ControlPage(characteristic: widget.characteristic, descriptorTiles: widget.descriptorTiles),
          ),
        );
      },
    );
      ...
      title: ListTile(
        ...
        subtitle: Row(
          ...
          children: [
            buildOnButton(context),
            buildOffButton(context),
            buildControlPageButton(context), // Add the Control Page button
          ],
        ),
        contentPadding: const EdgeInsets.all(0.0),
      ),
